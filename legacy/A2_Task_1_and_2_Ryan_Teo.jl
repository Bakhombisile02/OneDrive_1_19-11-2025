...
# ╔═╡ a2cd3d56-345f-41aa-bc7e-cac7c9bab5fc
using Statistics

# ╔═╡ 1e21d7d0-0bd4-4a1b-8248-82728d506f72
using LinearAlgebra

# ╔═╡ f88684df-7614-4cc3-96a0-4f9579b97a6b
using MLJLIBSVMInterface, LIBSVM

# ╔═╡ 20abd21f-a5c4-47e5-962a-f0ed1b96b651
using DecisionTree,MLJDecisionTreeInterface 

# ╔═╡ 3455b623-d6c4-4484-b2de-51b3183059a8
using NearestNeighborModels

# ╔═╡ 78d10be9-063c-4049-b454-182295b2505c
using MLJ

# ╔═╡ c7fefff6-9e25-4e83-96a5-b1917dc3e891
using Random

# ╔═╡ b8ca853a-e30d-4bbb-9205-fa5ca5e165a8
using StatsPlots
...
# ╔═╡ d382b444-7923-41f5-b9f1-faa264b4df94
begin
    println("Adding MFCC + TQWT fusion to X_schemes...")

    X_fused = hcat(X_schemes["MFCC"], X_schemes["TQWT"])

    X_fused_std = standardize(DataFrame(X_fused, :auto))

    X_schemes["MFCC_TQWT_Fusion"] = Matrix(X_fused_std)
end
...
function visualize_scheme(X, y, scheme_name;
    ...
    pca_dim = min(pca_dim, n_features, n_samples - 1, 50)
...
begin
	...
	plot(plots_list..., layout=(8,1), size=(1000, 4000))
end
...
manifest_format = "2.0"
project_hash = "bba3a1f2a941fcd8973aea83ed7d98e23f20d851"
